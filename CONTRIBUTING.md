...
You need **Node.js 22, 24 or 26** (the version range the plugin declares in `engines`). CI runs the test suite on Node 22, 24 and 26, so anything you land must pass on all three.
